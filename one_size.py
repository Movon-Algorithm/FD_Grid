...
def process_video(video_file, faceDetector, preprocs, faceBoxesCfg_yaml):
    ...
    logging.info(f"Processing video: {video_filename}, Total frames: {frame_count}, FPS: {fps}, Duration: {duration}s")
    ...
    while cap.isOpened():
        ...
        try:
            ...
            faceDetections = np.array([])  # Ensure faceDetections is an array
